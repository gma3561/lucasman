...
with st.sidebar:
    ...
    with col2:
        if st.button("계산하기", key="calculate_button", use_container_width=True, 
                    on_click=lambda: setattr(st.session_state, 'show_result', True),
                    type="primary"):
            pass  # 버튼 스타일은 위에서 적용
